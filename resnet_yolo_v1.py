...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1470):
        ...
        self.conv_end = nn.Conv2d(256, yolo_output, kernel_size=3, stride=1, padding=1, bias=False)
        self.bn_end = nn.BatchNorm2d(yolo_output)
...
#         x = F.sigmoid(x)  # 归一化到0-1
        # x = x.view(-1,7,7,24)
        x = x.permute(0, 2, 3, 1)  # (-1,7,7,30)# yolo v1利用resnet，修改输出层，输出7，7，30的特征向量
